...
public class WordCountCombiner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        j.setMapperClass(WordCountCombiner.MapForWordCount.class);
        j.setReducerClass(WordCountCombiner.ReduceForWordCount.class);

        // Important: sets the COMBINER!
        j.setCombinerClass(WordCountCombiner.CombinerForWordCount.class);
